...
- [0003: Authority frames and per-plane synchronization](0003-authority-frames-and-plane-synchronization.md) — deployed session-runtime, IPC, command, and authority-reducer architecture.
